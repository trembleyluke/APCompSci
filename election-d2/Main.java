public class Main {
    ...
    for(int i = 0; i < first.length; i++){
        ...
        for(int j = 0; j < first.length; j++){
            if(allBallots[i][0] == allBallots[j][0] && i != j){
                y++;
            }else{
        ...
        if(y<1){
            ...
            if (allBallots[i][1]== 1){
                MG++;
            }else if(allBallots[i][1] == 2) {
                SG= SG + 1;
            } else if (allBallots[i][1] == 3) {
                SE++;
            } else if (allBallots[i][1] == 4) {
                RV++;
            }
            if (allBallots[i][2] == 1) {
                DS++;
            } else if (allBallots[i][2] == 2) {
                TA++;
            } else if (allBallots[i][2] == 3) {
                JC++;
            } else if (allBallots[i][2] == 4) {
                BL++;
            }
            if (allBallots[i][3] == 1) {
                JH++;
            } else if (allBallots[i][3] == 2) {
                NR++;
            } else if (allBallots[i][3] == 3) {
                PF++;
            } else if (allBallots[i][3] == 4) {
                NE++;
            }
            if (allBallots[i][4] == 1) {
                DG++;
            } else if (allBallots[i][4] == 2) {
                SB++;
            } else if (allBallots[i][4] == 3) {
                WR++;
            } else if (allBallots[i][4] == 4) {
                HH++;
            }
        }
    }
        System.out.println("President");
        System.out.println("Golding,Mordy = " + MG);
        System.out.println("Gotshalk, Shira = " + SG);
        System.out.println("Evans, Stephanie = " + SE);
        System.out.println("Villalobros, Ray = "+ RV);
        System.out.println(" ");
        System.out.println("Vice President");
        System.out.println("Sarkar, Dona = " + DS);
        System.out.println("Ahn, Tyler = " + TA);
        System.out.println("Camp, Joe = " + JC);
        System.out.println("LeBlanc, Brandon = " + BL);
        System.out.println(" ");
        System.out.println("Secretary");
        System.out.println("Howard, Jason = " + JH);
        System.out.println("Rubino, Nikki = " + NR);
        System.out.println("Fisher, Peggy = " + PF);
        System.out.println("Edde, Neil = " + NE);
        System.out.println(" ");
        System.out.println("Treasurer");
        System.out.println("Gassner, David = " + DG);
        System.out.println("Bennett, Sharon = "+ SB);
        System.out.println("Ritscher, Walt = " + WR);
        System.out.println("Hurley, Heather = "+ HH);
